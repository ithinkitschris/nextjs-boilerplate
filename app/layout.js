            ...
            <VideoProvider>
              ...
              {changelog && (
                <motion.div
                  ...
                  {/* About */}
                  <motion.div className="glass-sm p-8 mt-4 md:mt-0 md:mr-2 h-[420px] md:h-[450px] overflow-y-auto no-scrollbar leading-[145%] bg-background dark:bg-black/10
                  ...
                  {/* To Do */}
                  <motion.div className="glass-sm p-8 mt-4 md:mt-0 md:ml-2 h-[400px] md:h-[450px] overflow-y-auto no-scrollbar leading-[145%] bg-background dark:bg-black/10 flex flex-col gap-2 backdrop-blur-3xl rounded-3xl drop-shadow-md pr-14"
                    initial="hidden"
                    animate="show"
                  ...
                  {/* Changelog Window */}
                  <motion.div className="glass-sm md:col-span-2 p-8 pr-10 mt-4 md:mt-0 md:ml-4 h-[100%] md:h-[450px] no-scrollbar bg-background relative flex flex-col
                    ...
                    <div className="grid grid-cols-2 gap-4 flex-1 min-h-0">
                      ...
                      <div className="no-scrollbar col-span-full md:col-span-1 flex flex-col gap-4 overflow-y-auto pr-4">
                        ...
                        <div className="flex flex-col gap-3 leading-4 mb-4">
                          <p className='text-foreground font-medium'>v3.01</p>

                          <p>Populated Expense Tracker project page with content, added design frames and videos of the app over the course of its development.</p>

                        </div>

                        <div className="flex flex-col gap-3 leading-4 mb-4">
                          <p className='text-foreground font-medium'>v3.0</p>

                          <p>v3! This iteration revamps the intro section at the top of the home page; it is now pure text and implements GSAP scrolling animations.</p>

                          <p className="">Horizontal skillset carousels from v2 have also been dropped in favour of a more direct highlights grid → archive grid layout.</p>
