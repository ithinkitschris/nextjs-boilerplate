  ...
  return (
    ...
    variants={animateIn}>
        ...
        <div className="col-span-full grid grid-cols-1 md:grid-cols-3 relative">
            ...
            the very backbone of what you are literally experiencing right now.</p>

            <p className="mt-5 md:mt-4">This website will always be a work-in-progress. If anything, I have designed for it to be ever-iterating; something I would be able to constantly return to with new insights from my journey as an Interaction Designer.
            Learnings, insights and perspectives that I will be able to both design implementations for and code into this very medium I have created for myself.</p>
            </motion.div>


            <div className="col-span-full mt-14 md:hidden">
            ...
            <p className="mt-4 hidden md:block">Read the documentation for  this website 
            ...
            href='https://ithinkitschris.notion.site/Portfolio-Website-127a92ab668680ed91ddd0619057466f' target="blank">here</a></p>
            </motion.div>
            
            <motion.div className="text-sm mt-6 md:mt-2 2xl:-mt-4 md:mr-14 px-4 lg:px-0 md:hidden" variants={animateInChild}>
