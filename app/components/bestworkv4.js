      ...
      <div className="relative w-full">
        ...
        <div className="flex overflow-x-auto gap-4 rounded-3xl mx-20" ref={containerRef}>
          ...
          <div 
              ...
              onMouseLeave={() => setHoveredIndex(null)}
              className={`min-w-[150%] snap-start col-span-full flex flex-row gap-4 rounded-3xl relative `}
            >

            <img src="/CCS/ep1teaser.png" className="h-[760px] col-span-full rounded-3xl object-cover "/>
            <img src="/CCS/thumbnail1.jpg" className="h-[760px] col-span-full rounded-3xl object-cover "/>
            <img src="/CCS/Teaser Fadzil.jpg" className="h-[760px] col-span-full rounded-3xl object-cover "/>
            <img src="/CCS/thumbnail6.jpg" className="h-[760px] col-span-full rounded-3xl object-cover "/>
          </div>
        </div>

        {/* Cocktail */}
        <div className="flex overflow-x-auto gap-4 rounded-3xl mx-20 mt-10" ref={containerRef}>
          ...
          <div 
              ...
              onMouseLeave={() => setHoveredIndex(null)}
              className={`${hoveredIndex === 0 ? 'min-w-[90%]' : 'min-w-[90%]'} snap-start col-span-full grid grid-cols-1 xl:grid-cols-9 group duration-300 rounded-3xl transition-all cursor-pointer relative`}
            >
