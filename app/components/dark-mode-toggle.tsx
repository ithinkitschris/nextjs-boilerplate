...
const DarkModeToggle: FC<DarkModeToggleProps> = ({ toggleDarkMode, isDarkMode }) => {
  return (
    <motion.button
      ...
      className="
      group mt-1.5 md:mt-1 bg-background backdrop-blur dark:bg-transparent saturate-150 md:saturate-100 backdrop-brightness-125 md:backdrop-brightness-100 shadow-glass-border-sm md:shadow-glass-border-sm 
