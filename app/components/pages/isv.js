...
const ISV = ({ className }) => {
  ...
  return (
      ...
      >
        ...
        <div className="absolute bottom-20 mx-auto text-center text-foreground text-base"> 
          <div className="flex flex-col gap-2 items-center justify-center">
            <img src="/isv/logo.png" className="w-28 h-auto" />
            <p className="font-medium text-2xl tracking-tight">In-Flight Safety Video '25</p>     
          </div>
        </div>
      </section>
      ...
      >
        ...
        <div className="absolute inset-0">
          <img 
            ref={section3Bg1Ref}
            src="/isv/section3bg1.png" 
            alt="Section 3 Background 1" 
            className="absolute inset-0 w-full h-full object-cover"
          />
          <img 
            ref={section3Bg2Ref}
            src="/isv/section3bg2.png" 
            alt="Section 3 Background 2" 
            className="absolute inset-0 w-full h-full object-cover"
          />
          <img 
            ref={section3Bg3Ref}
            src="/isv/section3bg3.png" 
            alt="Section 3 Background 3" 
            className="absolute inset-0 w-full h-full object-cover"
          />
          <img 
            ref={section3Bg4Ref}
            src="/isv/section3bg4.png" 
