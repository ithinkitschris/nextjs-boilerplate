...
const Currently = ({className, toggleWork, useOptimizedVideos = true}) => {
  return (
    <motion.div
    className={`font-[family-name:var(--font-geist-sans)] relative w-full grid grid-cols-2 md:grid-cols-8 gap-2 md:gap-4 ${className}`}
    initial="hidden"
    animate="show"
    variants={animateIn}>

      {/* 01 */}
      <motion.div className="col-span-full md:col-span-5 mt-16 h-full relative md:mb-4 group">
        ...
        <motion.div 
          ...
          <img src="/isv/logo.png" className="absolute right-5 bottom-5 w-20 h-auto z-20 opacity-50" />

          {/* Video */}
          <motion.div className="rounded-3xl w-full col-span-full h-[250px] lg:h-[420px] 2xl:h-[550px] relative overflow-hidden border-b-1 border-white/15">
        ...
        <motion.div 
          ...
          <motion.div className="rounded-3xl w-full col-span-full h-[250px] lg:h-[420px] 2xl:h-[550px] relative overflow-hidden border-b-1 border-white/15">
              ...
              <img 
                ...
                alt="Subway lockup"
                className="absolute top-1/2 left-[52.5%] transform -translate-x-1/2 -translate-y-1/2 z-20 max-w-[80%] h-auto object-contain"
              />
          </motion.div>
      ...
      {/* 03 */}
      <motion.div className="col-span-full md:col-span-4 group cursor-pointer h-full relative group md:mb-4">
        ...
        <motion.div 
          ...
          {/* Video */}
          <motion.div className="rounded-3xl w-full col-span-full h-[250px] lg:h-[420px] 2xl:h-[450px] relative overflow-hidden border-b-1 border-white/15">
        ...
        {/* Header and Description Container */}
        <div className="grid grid-cols-1 mb-8 mt-4 md:mt-6">

          <h1 className="tracking-[-0.5pt] md:tracking-[-0.8pt] font-medium text-lg md:text-[16pt] md:group-hover:ml-3 transition-all duration-200 md:w-4/5 leading-tight md:leading-6">
            Bloom
          </h1>

          <h3 className={`opacity-80 group-hover:opacity-100 transition-all md:group-hover:ml-3 duration-200 mt-0.5 tracking-normal text-xs leading-tight md:text-[11pt] w-[90%]`}>
            Stanford Longevity Design Challenge – First Place
          </h3>
          
          <h3 className={`opacity-70 mt-3 md:group-hover:opacity-100 md:group-hover:ml-3 transition-all duration-300 tracking-normal md:pr-10 text-xs md:text-sm md:leading-tight w-3/4`}>
