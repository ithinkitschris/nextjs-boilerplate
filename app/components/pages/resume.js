            ...
            <div key="bio-section" className="lg:flex col-span-full w-full relative">
                ...
                <div className="flex-1 lg:mb-10 border-0 md:hidden">
                    ...
                    className="mb-12 lg:mb-0 px-5 md:px-0 ml-1 mt-14">
                        ...
                        <p className="text-[22px] tracking-tight -ml-4"><span className="text-[30px] opacity-100 font-script2 align-top relative -top-2 mr-2 ml-1">1</span> I don&apos;t take myself too seriously.</p>
