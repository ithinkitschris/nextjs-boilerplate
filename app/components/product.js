    ...
    variants={animateIn}>
      ...
      <div className="relative w-full">
        ...
        <div className="flex overflow-x-auto gap-4 rounded-3xl mx-20" ref={containerRef}>
          ...
          className="min-w-[53%] snap-start col-span-full grid grid-cols-1 xl:grid-cols-9 group duration-300 rounded-3xl transition cursor-pointer relative hover:scale-98"
          >
            ...
            {/* Side Container */}
            <div className="absolute z-40 pl-10 pt-6 group-hover:p-10 w-[40%] group-hover:w-[50%] h-full text-white group-hover:bg-white/10 dark:group-hover:bg-black/20 backdrop-blur-none group-hover:backdrop-blur-2xl rounded-3xl group-hover:shadow-lg transition-all duration-300">
