...
export const videoData = [
  ...
  { src: '/optimized/expense/cover_1.mp4', title: 'On-device LLM Expense Tracker', subheader: 'A personal pet project for frontend iOS development with Swift and Foundation Models React Native, FastAPI, and Ollama.', poster: '', tags: ['expense', 'all', 'product'], link: '/expense' },
  ...
  { src: '/optimized/uniqlo1/cover_1080p.mp4', title: 'Your Stage Now Live', subheader: 'Motion Design for Uniqlo', poster: '/poster/uniqlo2.jpeg', tags: ['uniqlo1', 'all', 'motion'], link: '/uniqlo1' },
