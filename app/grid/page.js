      ...
      <div className={`col-span-full mb-5 sticky z-20 top-4 text-xl mr-28 
        moveUp`}>
          ...
          transition={{ duration: 0.5 }}> 
            ...
            <motion.h1
            className="font-semibold text-foreground text-2xl tracking-tight"
            layout
            ...
            {/* Best Button */}
            <motion.button 
            className={`hover:text-foreground text-left text-lg tracking-tight border-1.5 font-base rounded-full px-3 transition-colors
              ${selectedWork.includes('bestwork') ? 'text-foreground border-black dark:border-white font-medium' : ' text-[rgba(0,0,0,0.3)] dark:text-[rgba(255,255,255,0.5)] border-0 dark:hover:text-foreground dark:border-0'}`}
            whileHover={{scale:1.03}}
            variants={animateInChild}
            layout
            onClick={() => {
